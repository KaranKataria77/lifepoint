                    ...
                    <View style={{ height: hp('100%'), justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ height: hp('85%'), justifyContent: 'space-between' }}>
                            ...
                            <View style={{ width: wp('75%'), height: hp('12%'), justifyContent: 'space-between', alignSelf: 'center' }}>
                                <View style={{ flexDirection: 'row', width: wp('65%'), justifyContent: 'space-between' }}>
                                    <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                                        <Icons name="keyboard-backspace" size={25} color="#fff" />
                                    </TouchableOpacity>
                                    <Text style={{ fontSize: 26, color: '#fff' }}>Forgot Password?</Text>
                                </View>
                                <Text style={{ fontSize: 12, color: '#fff', lineHeight: 22 }}>Give your registered email address we will send you link to reset your password.</Text>
                            </View>

                            <View style={{ width: wp('75%'), height: hp('15%'), alignSelf: 'center', justifyContent: 'flex-start' }}>
                                <View>
