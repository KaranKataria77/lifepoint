    ...
    render() {
        return (
            <View style={styles.page}>
                ...
                <Text style={{fontSize:15, color:'#fff', paddingLeft:20, paddingTop:25, paddingBottom:25}}>DIGITAL MEMBER CARD</Text>
                <View style={{height:hp('60%'), width:wp('70%'), alignItems:'center', alignSelf:'center', justifyContent:'center'}}>
                <View style={{width:wp('60%'), height:hp('35%'), backgroundColor:'#fff', alignSelf:'center', alignItems:'center', justifyContent:'center', borderWidth:5, borderRadius:5, borderColor:'#A8A8A8'}}>
                    <Image source={require('../../assets/qr.png')} resizeMode="cover" style={{width:wp('58%'), height:hp('34%')}} />
                </View>
                </View>
